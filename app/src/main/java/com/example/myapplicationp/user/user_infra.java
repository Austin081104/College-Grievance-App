...
public class user_infra extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_infra);
        ...
        String[] issue = {"Select issue", "Classrooms & Lecture Halls", "Labs", "Restrooms", "Parking", "Security"};
    ...
    private void saveComplaintToFirestore() {
        ...
        if (Name.isEmpty() || Email.isEmpty() || Complaint.isEmpty() || RollNo.isEmpty() ||
            ...
            Toast.makeText(user_infra.this, "Please fill all fields", Toast.LENGTH_SHORT).show();
        } else {
            ...
            db.collection("Infarstructure_complaints").add(complaintData)
                    .addOnSuccessListener(documentReference -> {
                        Toast.makeText(user_infra.this, "Complaint Submitted!", Toast.LENGTH_SHORT).show();
                        Intent intent=new Intent(user_infra.this,user_complaint.class);
                        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
                        startActivity(intent);
                    })
                    .addOnFailureListener(e -> {
                        Toast.makeText(user_infra.this, "Error: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    });
        }
    }
    ...
    public void Home(View view){
        Intent intent=new Intent(user_infra.this,user_page.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
        startActivity(intent);
    }

    public void profile(View view){
        Intent intent=new Intent(user_infra.this, tab_profile.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
        startActivity(intent);
    }
    public void aboutus(View view){
        Intent intent=new Intent(user_infra.this, tab_aboutus.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
        startActivity(intent);
    }
    ...
    public void logout(View view){
        logoutMenu(user_infra.this);

    }
    private void logoutMenu(user_infra userPage) {
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                Intent intent=new Intent(user_infra.this, MainActivity.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
                startActivity(intent);
                finish();
