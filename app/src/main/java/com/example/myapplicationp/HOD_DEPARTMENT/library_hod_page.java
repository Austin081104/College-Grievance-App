...
import com.example.myapplicationp.admin.admin_view_library;
import com.example.myapplicationp.adminEdit.admin_edit_library;

public class library_hod_page extends AppCompatActivity {
    DrawerLayout drawerLayout;
    LinearLayout view,edit;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_library_hod_page);
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(library_hod_page.this, admin_view_library.class);
        ...
        edit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(library_hod_page.this, admin_edit_library.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);    startActivity(intent);
            }
        });
    }
    ...
    public void Home(View view){
        Intent intent=new Intent(library_hod_page.this,admin_page.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);   startActivity(intent);
    }
    ...
    public void logout(View view){
        logoutMenu(library_hod_page.this);

    }
    private void logoutMenu(library_hod_page adminPage) {
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                Intent intent=new Intent(library_hod_page.this, MainActivity.class);
