...
public class userstatus_complaint_bfm extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_userstatus_complaint_bfm);
    ...
    private void fetchUserComplaints() {
        ...
        db.collection("user_bfm_Complaints").whereEqualTo("email", userEmail)
                .addSnapshotListener(new EventListener<QuerySnapshot>() {
                    @Override
                    public void onEvent(QuerySnapshot queryDocumentSnapshots, FirebaseFirestoreException e) {
                        if (e != null) {
                            Toast.makeText(userstatus_complaint_bfm.this, "Error fetching data", Toast.LENGTH_SHORT).show();
                            return;
                        }
    ...
    class ComplaintAdapter extends ArrayAdapter<String> {
        ...
        ComplaintAdapter() {
            super(userstatus_complaint_bfm.this, R.layout.list_item_complaint, complaintList);
        }
    ...
    public void Home(View view) {
        Intent intent = new Intent(userstatus_complaint_bfm.this, user_page.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
        startActivity(intent);
    }

    public void profile(View view) {
        Intent intent = new Intent(userstatus_complaint_bfm.this, tab_profile.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
        startActivity(intent);
    }

    public void aboutus(View view) {
        Intent intent = new Intent(userstatus_complaint_bfm.this, tab_aboutus.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
        startActivity(intent);
    }

    public void logout(View view) {
        logoutMenu(userstatus_complaint_bfm.this);
    }

    private void logoutMenu(userstatus_complaint_bfm userPage) {
        new AlertDialog.Builder(userPage)
                .setTitle("LOGOUT")
                .setMessage("Are you sure you want to logout?")
                .setPositiveButton("Yes", (dialog, which) -> {
                    Intent intent = new Intent(userstatus_complaint_bfm.this, MainActivity.class);
                    intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
                    startActivity(intent);
                    finish();
                })
