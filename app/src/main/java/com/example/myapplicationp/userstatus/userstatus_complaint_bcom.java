...
public class userstatus_complaint_bcom extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_userstatus_complaint_bcom);
    ...
    private void fetchUserComplaints() {
        ...
        db.collection("user_bcom_Complaints").whereEqualTo("email", userEmail)
                .addSnapshotListener(new EventListener<QuerySnapshot>() {
                    @Override
                    public void onEvent(@Nullable QuerySnapshot queryDocumentSnapshots, @Nullable FirebaseFirestoreException e) {
                        if (e != null) {
                            Toast.makeText(userstatus_complaint_bcom.this, "Error fetching data", Toast.LENGTH_SHORT).show();
                            return;
                        }
    ...
    class ComplaintAdapter extends ArrayAdapter<String> {
        ...
        ComplaintAdapter() {
            super(userstatus_complaint_bcom.this, R.layout.list_item_complaint, complaintList);
        }
    ...
    public void Home(View view) {
        Intent intent = new Intent(userstatus_complaint_bcom.this, user_page.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
        startActivity(intent);
    }

    public void profile(View view) {
        Intent intent = new Intent(userstatus_complaint_bcom.this, tab_profile.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
        startActivity(intent);
    }

    public void aboutus(View view) {
        Intent intent = new Intent(userstatus_complaint_bcom.this, tab_aboutus.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
        startActivity(intent);
    }
    ...
    private void logoutMenu(userstatus_complaint_bcom userPage) {
        new AlertDialog.Builder(userPage)
                .setTitle("LOGOUT")
                .setMessage("Are you sure you want to logout?")
                .setPositiveButton("Yes", (dialog, which) -> {
                    Intent intent = new Intent(userstatus_complaint_bcom.this, MainActivity.class);
                    intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
                    startActivity(intent);
                    finish();
                })
