...
public class userstatus_library extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_userstatus_library);

        drawerLayout = findViewById(R.id.drawer_layout);
        listView = findViewById(R.id.listViewLibraryComplaints);
    ...
    private void fetchUserComplaints() {
        ...
        db.collection("Library_complaints").whereEqualTo("email", userEmail)
                .addSnapshotListener(new EventListener<QuerySnapshot>() {
                    @Override
                    public void onEvent(QuerySnapshot queryDocumentSnapshots, FirebaseFirestoreException e) {
                        if (e != null) {
                            Toast.makeText(userstatus_library.this, "Error fetching data", Toast.LENGTH_SHORT).show();
                            return;
                        }
    ...
    class ComplaintAdapter extends ArrayAdapter<String> {
        ...
        ComplaintAdapter() {
            super(userstatus_library.this, R.layout.list_item_complaint, complaintList);
        }
    ...
    public void Home(View view) {
        Intent intent = new Intent(userstatus_library.this, user_page.class);
    ...
    public void profile(View view) {
        Intent intent = new Intent(userstatus_library.this, tab_profile.class);                    intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
    ...
    public void aboutus(View view) {
        Intent intent = new Intent(userstatus_library.this, tab_aboutus.class);                    intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
    ...
    private void logoutMenu(userstatus_library userPage) {
        new AlertDialog.Builder(userPage)
                .setTitle("LOGOUT")
                .setMessage("Are you sure you want to logout?")
                .setPositiveButton("Yes", (dialog, which) -> {
                    Intent intent = new Intent(userstatus_library.this, MainActivity.class);
                    intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
