...
public class admin_edit_infra extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_edit_infra);

        drawerLayout = findViewById(R.id.drawer_layout);
        listView = findViewById(R.id.listViewInfraComplaints);
    ...
    private void fetchComplaints() {
        db.collection("Infarstructure_complaints")
                .orderBy("timestamp", Query.Direction.DESCENDING)  // Newest first
                .addSnapshotListener(new EventListener<QuerySnapshot>() {
                    @Override
                    public void onEvent(@Nullable QuerySnapshot queryDocumentSnapshots, @Nullable FirebaseFirestoreException e) {
                        if (e != null) {
                            Toast.makeText(admin_edit_infra.this, "Error fetching data", Toast.LENGTH_SHORT).show();
                            return;
                        }
    ...
    private void updateStatus(String docId, String newStatus) {
        DocumentReference docRef = db.collection("Infarstructure_complaints").document(docId);
        Map<String, Object> updates = new HashMap<>();
        updates.put("status", newStatus);

        docRef.update(updates)
                .addOnSuccessListener(aVoid -> Toast.makeText(admin_edit_infra.this, "Status Updated to " + newStatus, Toast.LENGTH_SHORT).show())
                .addOnFailureListener(e -> Toast.makeText(admin_edit_infra.this, "Error updating status", Toast.LENGTH_SHORT).show());
    }

    class ComplaintAdapter extends ArrayAdapter<String> {

        ComplaintAdapter() {
            super(admin_edit_infra.this, R.layout.list_item_complaint, complaintList);
        }
    ...
    public void Home(View view) {
        startActivity(new Intent(admin_edit_infra.this, admin_page.class));
    }
    ...
    private void logoutMenu(admin_edit_infra adminPage) {
        new AlertDialog.Builder(adminPage)
                .setTitle("LOGOUT")
                .setMessage("Are you sure you want to logout?")
                .setPositiveButton("Yes", (dialog, which) -> {
                    Intent intent = new Intent(admin_edit_infra.this, MainActivity.class);
