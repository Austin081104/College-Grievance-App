...
public class adminedit_complaint_bscit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adminedit_complaint_bscit);

        drawerLayout = findViewById(R.id.drawer_layout);
        listView = findViewById(R.id.listViewBscitComplaints);
    ...
    private void fetchComplaints() {
        db.collection("user_bscit_Complaints")
                .orderBy("timestamp", Query.Direction.DESCENDING)
                .addSnapshotListener(new EventListener<QuerySnapshot>() {
                    @Override
                    public void onEvent(@Nullable QuerySnapshot queryDocumentSnapshots, @Nullable FirebaseFirestoreException e) {
                        if (e != null) {
                            Toast.makeText(adminedit_complaint_bscit.this, "Error fetching data", Toast.LENGTH_SHORT).show();
                            return;
                        }
    ...
    private void updateStatus(String docId, String newStatus) {
        DocumentReference docRef = db.collection("user_bscit_Complaints").document(docId);
        Map<String, Object> updates = new HashMap<>();
        updates.put("status", newStatus);

        docRef.update(updates)
                .addOnSuccessListener(aVoid -> Toast.makeText(adminedit_complaint_bscit.this, "Status Updated to " + newStatus, Toast.LENGTH_SHORT).show())
                .addOnFailureListener(e -> Toast.makeText(adminedit_complaint_bscit.this, "Error updating status", Toast.LENGTH_SHORT).show());
    }

    class ComplaintAdapter extends ArrayAdapter<String> {

        ComplaintAdapter() {
            super(adminedit_complaint_bscit.this, R.layout.list_item_complaint, complaintList);
        }
    ...
    public void Home(View view) {
        startActivity(new Intent(adminedit_complaint_bscit.this, admin_page.class));
    }
    ...
    private void logoutMenu(adminedit_complaint_bscit adminPage) {
        new AlertDialog.Builder(adminPage)
                .setTitle("LOGOUT")
                .setMessage("Are you sure you want to logout?")
                .setPositiveButton("Yes", (dialog, which) -> {
                    Intent intent = new Intent(adminedit_complaint_bscit.this, MainActivity.class);
