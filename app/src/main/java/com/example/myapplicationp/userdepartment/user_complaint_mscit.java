...
public class user_complaint_mscit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mscit);
        ...
        String[] Class = {"Select Class", "First Year", "Second Year"};
        ArrayAdapter<String> adapter = new ArrayAdapter<>(this, R.layout.spinner_item, Class);
        adapter.setDropDownViewResource(R.layout.spinner_item);
        spinnerclass.setAdapter(adapter);

        String[] issue = {"Select issue", "Teachers", "Classroom", "Lab Equipment", "Syllabus", "Exams & Results", "Attendance"};
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Name.isEmpty() || Email.isEmpty() || Complaint.isEmpty() || RollNo.isEmpty() || Class.isEmpty()|| Issue.isEmpty()) {
                    Toast.makeText(user_complaint_mscit.this, "Please fill all fields", Toast.LENGTH_SHORT).show();
                }else {
    ...
    private void saveComplaintToFirestore(String name, String rollNo, String email, String complaint, String class1, String issue) {
        ...
        db.collection("user_mscit_Complaints") // Firestore Collection
                .add(complaintData)
                .addOnSuccessListener(documentReference -> {
                    Toast.makeText(user_complaint_mscit.this, "Complaint submitted successfully!", Toast.LENGTH_SHORT).show();
                    Intent intent=new Intent(user_complaint_mscit.this, user_complaint.class);
                    intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
                    startActivity(intent);
                })
                .addOnFailureListener(e -> {
                    Toast.makeText(user_complaint_mscit.this, "Error submitting complaint", Toast.LENGTH_SHORT).show();
                });
    }
    ...
    public void Home(View view){
        Intent intent=new Intent(user_complaint_mscit.this, user_page.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
        startActivity(intent);
    }

    public void profile(View view){
        Intent intent=new Intent(user_complaint_mscit.this, tab_profile.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
        startActivity(intent);
    }
    public void aboutus(View view){
        Intent intent=new Intent(user_complaint_mscit.this, tab_aboutus.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
        startActivity(intent);
    }
    ...
    public void logout(View view){
        logoutMenu(user_complaint_mscit.this);

    }
    private void logoutMenu(user_complaint_mscit userPage) {
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                Intent intent=new Intent(user_complaint_mscit.this, MainActivity.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
                startActivity(intent);
                finish();
