...
public class user_complaint_bcom extends AppCompatActivity {
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Name.isEmpty() || Email.isEmpty() || Complaint.isEmpty() || RollNo.isEmpty() || Class.isEmpty()|| Issue.isEmpty()) {
                    Toast.makeText(user_complaint_bcom.this, "Please fill all fields", Toast.LENGTH_SHORT).show();
                }else {
    ...
    private void saveComplaintToFirestore(String name, String rollNo, String email, String complaint, String class1, String issue) {
        ...
        db.collection("user_bcom_Complaints") // Firestore Collection
                .add(complaintData)
                .addOnSuccessListener(documentReference -> {
                    Toast.makeText(user_complaint_bcom.this, "Complaint submitted successfully!", Toast.LENGTH_SHORT).show();
                    Intent intent=new Intent(user_complaint_bcom.this, user_complaint.class);
                    intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
                    startActivity(intent);
                })
                .addOnFailureListener(e -> {
                    Toast.makeText(user_complaint_bcom.this, "Error submitting complaint", Toast.LENGTH_SHORT).show();
                });
    }
    ...
    public void Home(View view){
        Intent intent=new Intent(user_complaint_bcom.this, user_page.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
        startActivity(intent);
    }

    public void profile(View view){
        Intent intent=new Intent(user_complaint_bcom.this, tab_profile.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
        startActivity(intent);
    }
    public void aboutus(View view){
        Intent intent=new Intent(user_complaint_bcom.this, tab_aboutus.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
        startActivity(intent);
    }
    ...
    public void logout(View view){
        logoutMenu(user_complaint_bcom.this);

    }
    private void logoutMenu(user_complaint_bcom userPage) {
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                Intent intent=new Intent(user_complaint_bcom.this, MainActivity.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
                startActivity(intent);
                finish();
