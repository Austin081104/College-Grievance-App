...
public class CanteenComplaintAdapter extends RecyclerView.Adapter<CanteenComplaintAdapter.CanteenComplaintViewHolder> {

    private List<CanteenComplaint> complaintList;

    public CanteenComplaintAdapter(List<CanteenComplaint> complaintList) {
        this.complaintList = complaintList;
    }

    @NonNull
    @Override
    public CanteenComplaintViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_canteen_complaint, parent, false);
        return new CanteenComplaintViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull CanteenComplaintViewHolder holder, int position) {
        CanteenComplaint complaint = complaintList.get(position);
    ...
    public static class CanteenComplaintViewHolder extends RecyclerView.ViewHolder {
        TextView name, rollNo, email, className, department, issue, complaintText;

        public CanteenComplaintViewHolder(@NonNull View itemView) {
            super(itemView);
