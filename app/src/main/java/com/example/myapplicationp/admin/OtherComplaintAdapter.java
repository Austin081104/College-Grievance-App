...
public class OtherComplaintAdapter extends RecyclerView.Adapter<OtherComplaintAdapter.OtherComplaintViewHolder> {

    private List<OtherComplaint> complaintList;

    public OtherComplaintAdapter(List<OtherComplaint> complaintList) {
        this.complaintList = complaintList;
    }

    @NonNull
    @Override
    public OtherComplaintViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_other_complaint, parent, false);
        return new OtherComplaintViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull OtherComplaintViewHolder holder, int position) {
        OtherComplaint complaint = complaintList.get(position);
    ...
    public static class OtherComplaintViewHolder extends RecyclerView.ViewHolder {
        TextView name, rollNo, email, className, department, issue, complaintText;

        public OtherComplaintViewHolder(@NonNull View itemView) {
            super(itemView);
