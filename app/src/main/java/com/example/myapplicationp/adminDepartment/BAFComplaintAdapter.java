...
public class BAFComplaintAdapter extends RecyclerView.Adapter<BAFComplaintAdapter.BAFComplaintViewHolder> {

    private List<BAFComplaint> complaintList;

    public BAFComplaintAdapter(List<BAFComplaint> complaintList) {
        this.complaintList = complaintList;
    }

    @NonNull
    @Override
    public BAFComplaintViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_baf_complaint, parent, false);
        return new BAFComplaintViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull BAFComplaintViewHolder holder, int position) {
        BAFComplaint complaint = complaintList.get(position);
    ...
    public static class BAFComplaintViewHolder extends RecyclerView.ViewHolder {
        TextView name, rollNo, email, className, issue, complaintText;

        public BAFComplaintViewHolder(@NonNull View itemView) {
            super(itemView);
